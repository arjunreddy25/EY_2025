    ...
    <TooltipProvider>
      <div className="border-t bg-background px-4 py-4">
        <div className="mx-auto max-w-3xl">
          ...
          {/* Input container */}
          <div className="relative flex items-end gap-2 rounded-2xl border bg-muted/30 p-2 shadow-sm transition-shadow focus-within:shadow-md">
            {/* File upload button */}
            <Tooltip>
            ...
            <Textarea
              ...
              disabled={disabled}
              className={cn(
                "min-h-[44px] max-h-[200px] flex-1 resize-none border-0 bg-transparent px-2 py-3",
